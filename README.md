...
Project Overview
The Core Java MAVEN healthcare Management Project is a basic Java application that demonstrates a Appointment booking management system. It utilizes object-oriented programming principles and simulates the interactions between persons, doctors, hospitals , and appointments.
...
<ul>
  <li>cd maven-healthcare-management-system</li>
